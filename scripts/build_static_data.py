...
def build(args: argparse.Namespace) -> None:
    ...
    metadata.update({
        ...
        "static_narrative_storage": "Year-partitioned JavaScript chunks containing public narrative excerpts loaded on demand",
    ...
    (data_dir / "STATIC_DATA_SCHEMA.md").write_text(
        ...
        "and public narrative excerpts are split into year-based chunks that are loaded only when a narrative table is opened.\n\n"
